...
namespace Drupal\site_custom\Routing;
 ...
 */
class SiteApiKeySiteRouteSubscriber extends RouteSubscriberBase
{
    /**
     * {@inheritdoc}
     */
    protected function alterRoutes(RouteCollection $collection)
    {
        ...
        if($route = $collection->get('system.site_information_settings'))
        {
            ...
            $route->setDefault('_form', 'Drupal\site_custom\Form\ExtendedSiteInformationForm');
        }
    }
}
?>